...
export default function ExtractionRules() {
  return <SettingsStub title="Extraction Rules" icon={Filter} description="Configure rules for extracting structured data (dimensions, weight, colour, material, etc.) from Sunsky product specification tables." />;
}
