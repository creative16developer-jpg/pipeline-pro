...
export default function ImagesSettings() {
  return <SettingsStub title="Images" icon={Image} description="Configure image processing defaults: output format (WebP), compression quality, maximum dimensions, and watermark settings applied during the pipeline's image processing step." />;
}
