...
export default function AttributeMapping() {
  return <SettingsStub title="Attribute Mapping" icon={Layers} description="Define how Sunsky product attributes map to WooCommerce product attributes. Configure extraction rules and value transformations." />;
}
