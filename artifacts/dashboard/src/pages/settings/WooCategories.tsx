...
export default function WooCategories() {
  return <SettingsStub title="WooCommerce Categories" icon={Tag} description="View the WooCommerce category tree pulled from your connected stores. Use Pull from WooCommerce on the Stores page to refresh category data." />;
}
