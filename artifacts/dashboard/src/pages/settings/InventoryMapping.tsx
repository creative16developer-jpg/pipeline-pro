...
export default function InventoryMapping() {
  return <SettingsStub title="Inventory Mapping" icon={BarChart3} description="Map Sunsky stock status values to WooCommerce inventory settings, including in-stock thresholds, backorder rules, and stock quantity defaults." />;
}
