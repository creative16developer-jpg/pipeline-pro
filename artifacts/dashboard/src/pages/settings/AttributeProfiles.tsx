import { Filter, Construction } from "lucide-react";

export default function AttributeProfiles() {
  return <SettingsStub title="Attribute Profiles" icon={Filter} description="Create reusable attribute profiles to apply consistent attribute sets across multiple product categories during the pipeline process." />;
}
