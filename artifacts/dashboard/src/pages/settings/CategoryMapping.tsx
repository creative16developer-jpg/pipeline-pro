...
export default function CategoryMapping() {
  return <SettingsStub title="Category Mapping" icon={ArrowLeftRight} description="Map Sunsky product categories to your WooCommerce store categories. Unmapped categories trigger a pipeline pause for manual review." />;
}
